...
function reservaHotel(nombreCliente, cantidadNoches, pagoRealizado) {
    if (!reserva.nombreCliente) {
        console.log("Debe ingresar un nombre válido");
    }
    else {
        console.log("Nombre del cliente: ".concat(reserva.nombreCliente));
    }
    if (!reserva.cantidadNoches || reserva.cantidadNoches <= 1) {
        console.log("La cantidad de noches debe ser mayor a 0");
    }
    else {
        console.log("Cantidad de noches: ".concat(reserva.cantidadNoches));
    }
